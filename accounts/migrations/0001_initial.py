    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SUPERADMIN', 'Super Admin'), ('TEACHER', 'Enseignant'), ('PARENT', 'Parent'), ('STUDENT', 'Élève')], default='STUDENT', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_level', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='curriculum.classlevel')),
